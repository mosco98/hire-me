...
const HomePage = () => {
  ...
  return (
    <div className="font-black" style={{ perspective: 1000 }}>
      ...
      >
        <motion.p
          className="big-text opacity-0 hover:opacity-100 transition duration-300 uppercase text-center max-w-lg leading-[140px] text-transparent"
          style={{
        ...
        <motion.div
          className="absolute -inset-px glow pointer-events-none opacity-0 group-hover:opacity-100 transition duration-300 shadow-2xl"
          style={{
            background: useMotionTemplate`radial-gradient(250px circle at ${mouseX}px ${mouseY}px,rgba(36, 36, 36, 0.8),transparent 50%)`
          }}
        ></motion.div>
      </motion.div>
    </div>
